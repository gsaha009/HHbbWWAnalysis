...
class highlevelLambdasSL:
    def __init__(self, BaseSelf):
        ...
        self.MT_W1W2_ljj = lambda lep,j1,j2,met : op.sqrt(2*lep2j_p4(lep,j1,j2).Pt()*met.pt*(1-op.cos(lep2j_p4(lep,j1,j2).Phi()-met.phi)))
        self.MT_W1W2_lj  = lambda lep,j1,met : op.sqrt(2*lep1j_p4(lep,j1).Pt()*met.pt*(1-op.cos(lep1j_p4(lep,j1).Phi()-met.phi)))
        ...
        self.HT2R_l3jmet = lambda l,j1,j2,j3,met : HT2_l3jmet(met,l,j1,j2,j3)/(met.pt+l.p4.Pt()+j1.p4.Pt()+j2.p4.Pt()+j3.p4.Pt())
        ...
        self. HT2R_l4jmet = lambda l,j1,j2,j3,j4,met : HT2_l4jmet(met,l,j1,j2,j3,j4)/(met.pt+l.p4.Pt()+j1.p4.Pt()+j2.p4.Pt()+j3.p4.Pt()+j4.p4.Pt())
