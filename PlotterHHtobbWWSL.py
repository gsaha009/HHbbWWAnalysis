...
class PlotterNanoHHtobbWWSL(BaseNanoHHtobbWW,DataDrivenBackgroundHistogramsModule):
    ...
    def definePlots(self, t, noSel, sample=None, sampleCfg=None): 
        ...
        jet_level = ["Ak4","Ak8","Res2b2Wj","Res2b1Wj","Res2b0Wj","Res1b2Wj","Res1b1Wj","Res1b0Wj","Hbb2Wj","Hbb1Wj","Resolved","Boosted"]
        ...
        if "Hbb2Wj" in jetsel_level or "Hbb1Wj" in jetsel_level or "Boosted" in jetsel_level:     
            jetsel_level.append("Ak8") # SemiBoosted & Boosted needs the Ak8 selection
        if "Res2b2Wj" in jetsel_level or "Res2b1Wj" in jetsel_level or "Res2b0Wj" in jetsel_level or "Res1b2Wj" in jetsel_level or "Res1b1Wj" in jetsel_level or "Res1b0Wj" in jetsel_level or "Resolved" in jetsel_level:
        ...
        for selectionType, selectionList in selObjectDict.items():
            ...
            if selectionType == "Preselected":  
                ...
                ElColl = [t.Electron[op.switch(op.rng_len(self.leadElectronTightSel) == 1, self.leadElectronTightSel[0].idx, self.leadElectronFakeExtrapolationSel[0].idx)]]
                MuColl = [t.Muon[op.switch(op.rng_len(self.leadMuonTightSel) == 1, self.leadMuonTightSel[0].idx, self.leadMuonFakeExtrapolationSel[0].idx)]]
            ...
            if "Ak4" in jetsel_level:
                ...
                if "Resolved" in jetplot_level and not self.args.OnlyYield:
                ...
                #addPrintout(ElSelObjResolved.sel, "bamboo_printEntry", op.extVar("ULong_t", "rdfentry_"), t.event)
                #addPrintout(MuSelObjResolved.sel, "bamboo_printEntry", op.extVar("ULong_t", "rdfentry_"), t.event)
                ...
                if "Res2b2Wj" or "Resolved" in jetplot_level:
                    print ('...... JPA : 2b2Wj Node Selection : nAk4Jets >= 4')
                    ...
                    #cutFlowPlots.append(CutFlowReport(ElSelObjResolved2b2Wj.selName, ElSelObjResolved2b2Wj.sel))
                    #cutFlowPlots.append(CutFlowReport(MuSelObjResolved2b2Wj.selName, MuSelObjResolved2b2Wj.sel))

                    #plots.append(Plot.make1D("ElMaxVal_%s"%ElSelObjResolved2b2Wj.selName, ElMaxVal, ElSelObjResolved2b2Wj.sel, EquidistantBinning(25, 0.0, 1.0)))
                    #plots.append(Plot.make1D("MuMaxVal_%s"%MuSelObjResolved2b2Wj.selName, MuMaxVal, MuSelObjResolved2b2Wj.sel, EquidistantBinning(25, 0.0, 1.0)))
                ...
                if "Res2b1Wj" or "Resolved" in jetplot_level:
                    print ('...... JPA : 2b1Wj Node Selection : nAk4Jets >= 4')
                    ...
                    #cutFlowPlots.append(CutFlowReport(ElSelObjResolved2b1Wj.selName, ElSelObjResolved2b1Wj.sel))
                    #cutFlowPlots.append(CutFlowReport(MuSelObjResolved2b1Wj.selName, MuSelObjResolved2b1Wj.sel))

                    #plots.append(Plot.make1D("ElMaxVal_%s"%ElSelObjResolved2b1Wj.selName, ElMaxVal, ElSelObjResolved2b1Wj.sel, EquidistantBinning(25, 0.0, 1.0)))
                    #plots.append(Plot.make1D("MuMaxVal_%s"%MuSelObjResolved2b1Wj.selName, MuMaxVal, MuSelObjResolved2b1Wj.sel, EquidistantBinning(25, 0.0, 1.0)))
                ...
                if "Res2b0Wj" or "Resolved" in jetplot_level:
                    print ('...... JPA : 2b0Wj Node Selection : nAk4Jets >= 4')
                    ...
                    #plots.append(Plot.make1D("ElMaxVal_%s"%ElSelObjResolved2b0Wj.selName, ElMaxVal, ElSelObjResolved2b0Wj.sel, EquidistantBinning(25, 0.0, 1.0)))
                    #plots.append(Plot.make1D("MuMaxVal_%s"%MuSelObjResolved2b0Wj.selName, MuMaxVal, MuSelObjResolved2b0Wj.sel, EquidistantBinning(25, 0.0, 1.0)))

                    #cutFlowPlots.append(CutFlowReport(ElSelObjResolved2b0Wj.selName, ElSelObjResolved2b0Wj.sel))
                    #cutFlowPlots.append(CutFlowReport(MuSelObjResolved2b0Wj.selName, MuSelObjResolved2b0Wj.sel))
                ...
                if "Res1b2Wj" or "Resolved" in jetplot_level:
                    print ('...... JPA : 1b2Wj Node Selection : nAk4Jets >= 4')
                    ...
                    #cutFlowPlots.append(CutFlowReport(ElSelObjResolved1b2Wj.selName, ElSelObjResolved1b2Wj.sel))
                    #cutFlowPlots.append(CutFlowReport(MuSelObjResolved1b2Wj.selName, MuSelObjResolved1b2Wj.sel))

                    #plots.append(Plot.make1D("ElMaxVal_%s"%ElSelObjResolved1b2Wj.selName, ElMaxVal, ElSelObjResolved1b2Wj.sel, EquidistantBinning(25, 0.0, 1.0)))
                    #plots.append(Plot.make1D("MuMaxVal_%s"%MuSelObjResolved1b2Wj.selName, MuMaxVal, MuSelObjResolved1b2Wj.sel, EquidistantBinning(25, 0.0, 1.0)))
                ...
                if "Res1b1Wj" or "Resolved" in jetplot_level:
                    print ('...... JPA : 1b1Wj Node Selection : nAk4Jets >= 4')
                    ...
                    #plots.append(Plot.make1D("ElMaxVal_%s"%ElSelObjResolved1b1Wj.selName, ElMaxVal, ElSelObjResolved1b1Wj.sel, EquidistantBinning(25, 0.0, 1.0)))
                    #plots.append(Plot.make1D("MuMaxVal_%s"%MuSelObjResolved1b1Wj.selName, MuMaxVal, MuSelObjResolved1b1Wj.sel, EquidistantBinning(25, 0.0, 1.0)))
    
                    #cutFlowPlots.append(CutFlowReport(ElSelObjResolved1b1Wj.selName, ElSelObjResolved1b1Wj.sel))
                    #cutFlowPlots.append(CutFlowReport(MuSelObjResolved1b1Wj.selName, MuSelObjResolved1b1Wj.sel))
                ...
                if "Res1b0Wj" or "Resolved" in jetplot_level:
                    print ('...... JPA : 1b0Wj Node Selection : nAk4Jets >= 4')
                    ...
                    #plots.append(Plot.make1D("ElMaxVal_%s"%ElSelObjResolved1b0Wj.selName, ElMaxVal, ElSelObjResolved1b0Wj.sel, EquidistantBinning(25, 0.0, 1.0)))
                    #plots.append(Plot.make1D("MuMaxVal_%s"%MuSelObjResolved1b0Wj.selName, MuMaxVal, MuSelObjResolved1b0Wj.sel, EquidistantBinning(25, 0.0, 1.0)))

                    #cutFlowPlots.append(CutFlowReport(ElSelObjResolved1b0Wj.selName, ElSelObjResolved1b0Wj.sel))
                    #cutFlowPlots.append(CutFlowReport(MuSelObjResolved1b0Wj.selName, MuSelObjResolved1b0Wj.sel))
            ...
            if "Ak8" in jetsel_level:
                ...
                # Fatjets plots #
                if "Boosted" in jetplot_level and not self.args.OnlyYield:
                ...
                if "Hbb2Wj" or "Boosted" in jetplot_level:
                    ...
                    #cutFlowPlots.append(CutFlowReport(ElSelObjBoostedHbb2Wj.selName, ElSelObjBoostedHbb2Wj.sel))
                    #cutFlowPlots.append(CutFlowReport(MuSelObjBoostedHbb2Wj.selName, MuSelObjBoostedHbb2Wj.sel))
                ...
                if "Hbb1Wj" or "Boosted" in jetplot_level:
                    ...
                    #cutFlowPlots.append(CutFlowReport(ElSelObjBoostedHbb1Wj.selName, ElSelObjBoostedHbb1Wj.sel))
                    #cutFlowPlots.append(CutFlowReport(MuSelObjBoostedHbb1Wj.selName, MuSelObjBoostedHbb1Wj.sel))
                    if not self.args.OnlyYield:
